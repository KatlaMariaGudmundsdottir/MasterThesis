...
In the final LOS guidance system design we consider a planar path continuously paramaterized
\(\iota\)

\begin{figure} [H]
    \centering
    \includegraphics[width=0.65\linewidth]{images/inkscape/pathframe.png}
    \caption{Caption}
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.4\linewidth]{images/inkscape/pathframeRotation.png}
    \caption{Caption}
    \label{fig:enter-label}
\end{figure}
